...
## Receipt-first canonical truth doctrine — May 3, 2026 correction

Do not assume N=3, N=11, or N=12 from memory. Always read current canonical truth from backend truth files and receipts.

As of the May 3, 2026 recovery audit, local backend files indicate recovered N=11 after ghost N=12 corruption, but the recovery receipt promotion flag discrepancy must be checked before execution moves.

No canonical truth may be asserted without current receipt-backed evidence.
